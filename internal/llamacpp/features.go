...
type ValuesFeature struct {
	...
	RequestedValues []string            `json:"requested_values"`
	UsableValues    []string            `json:"usable_values"`
	Skipped         []domain.SkipReason `json:"skipped,omitempty"`
}

type ExtraArgsFeature struct {
	Requested    []config.ExtraArg   `json:"requested"`
	Usable       []config.ExtraArg   `json:"usable"`
	ServerUsable []config.ExtraArg   `json:"server_usable"`
