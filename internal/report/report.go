...
func PrintCompare(w io.Writer, baselineRows []domain.LoadedRun, candidateRows []domain.LoadedRun, opts SummaryOptions) error {
...
func aggregateOne(key ServerConfigKey, observations []RunObservation, context map[string]*float64, minHeadroomGB float64) AggregatedServerConfigReport {
...
func compareRow(report AggregatedServerConfigReport, baseline AggregatedServerConfigReport, details bool) map[string]string {
